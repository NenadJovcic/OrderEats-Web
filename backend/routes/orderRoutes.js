...
import { orders_get, orders_post, orders_delete, orders_getByOrdersId, orders_getByUserId } from '../controllers/orderController.js'
...
orderRoutes.get('/orderid/:id', verifyToken, restrictToAdmin, orders_getByOrdersId)
